...
export default function ProjectCard({ project, isFeatured = false }) {
  return (
    <article className={`project-card ${isFeatured || project.featured ? "featured-card" : ""}`}>
      ...
      <div className="project-card-tech">
        ...
        <div className="tech-tags">
          ...
          {project.technologies.length > 5 && (
            <span className="tech-tag" style={{ color: "var(--primary-teal)" }}>
      ...
      <div className="project-card-actions">
        <Link to={`/projects/${project.id}`} className="btn-case-study">
          View Case Study
